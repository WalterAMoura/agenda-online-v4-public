...
class WorshipTeam
{
     ...
     * @var string
     */
    private $tabela = 'tb_worship_team';
    /**
     * ‘ID’ do registro
     * @var integer
     */
     ...
     * @return WorshipTeam
     */
    public static function getWorshipTeamById($id)
    {
        return self::getWorshipTeam('id = '.$id)->fetchObject(self::class);
    }
     ...
     * @return WorshipTeam
     */
    public static function getWorshipTeamByLinkedUserId($id)
    {
        return self::getWorshipTeam('linked_user_id = '.$id)->fetchObject(self::class);
    }
     ...
     * @return WorshipTeam
     */
    public static function getWorshipTeamByName($name)
    {
        return self::getWorshipTeam('name = "'.$name.'"')->fetchObject(self::class);
    }
     ...
     * @param string $fields
     */
    public static function getWorshipTeam($where = null, $order = null, $limit = null, $group = null, $fields = '*'):PDOStatement
    {
        return (new Database('cnt_worship_team'))->select($where,$order,$limit,$group,$fields);
    }
}