...
class SendMessageWhatsAppWorship
{
    /**
     * Tabela usada pela classe
     * @var string
     */
    private string $tabela = 'tb_send_message_whatsapp_worship';
    ...
    public function cadastrar()
    {
        ...
        $this->id = (new Database($this->tabela))->insert([
            ...
            'worshipteam_id' => $this->worshipteam_id,
     ...
     * @param int $id
     * @return SendMessageWhatsAppWorship
     */
    ...
    {
        return (new Database('cnt_send_message_whatsapp_worship'))->select($where,$order,$limit,$group,$fields);
    }
}