...
class WorshipTeamLineup
{
    /**
     * Tabela usada pela classe
     * @var string
     */
    private $tabela = 'tb_worship_team_schedule';
     ...
     * @param integer $id
     * @return WorshipTeamLineup
     */
    public static function getWorshipTeamLineupById(int $id)
    {
        return self::getWorshipTeamLineup('id = '.$id)->fetchObject(self::class);
    }

    /**
     * Método por validar se existe uma escala
     * @param int $day
     * @param int $month
     * @param int $year
     * @return WorshipTeamLineup
     */
    public static function getWorshipTeamLineupByScheduler(int $day, int $month, int $year )
    {
        return self::getWorshipTeamLineup('day = ' . $day . ' AND month = ' . $month . ' AND  year = ' . $year)->fetchObject(self::class);
    }
    ...
    {
        return (new Database('cnt_worship_team_schedule'))->select($where,$order,$limit,$group,$fields);
    }
}