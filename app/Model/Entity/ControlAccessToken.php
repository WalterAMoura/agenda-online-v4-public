...
class ControlAccessToken
{
     ...
     * @var string
     */
    private $tabela = 'tb_control_access_token';
     ...
     */
    public static function getControlAccessTokenById($settingsSmtpId)
    {
        return self::getControlAccessToken('id = '.$settingsSmtpId)->fetchObject(self::class);
    }
     ...
     * @return ActiveAccountUsers
     */
    public static function getControlAccessTokenByToken(string $token)
    {
        return self::getControlAccessToken('token = "'.$token.'"')->fetchObject(self::class);
    }
     ...
     * @param string $fields
     */
    public static function getControlAccessToken($where = null, $order = null, $limit = null, $group = null, $fields = '*'):PDOStatement
    {
        return (new Database('cnt_control_access_token'))->select($where,$order,$limit,$group,$fields);
    }
}