...
class ReceptionTeam
{
     ...
     * @var string
     */
    private $tabela = 'tb_reception_team';
    /**
     * ‘ID’ do registro
     * @var integer
     */
     ...
     */
    public static function getReceptionTeamById($id)
    {
        return self::getReceptionTeam('id = '.$id)->fetchObject(self::class);
    }
     ...
     * @return ReceptionTeam
     */
    public static function getReceptionTeamByLinkedUserId($id)
    {
        return self::getReceptionTeam('linked_user_id = '.$id)->fetchObject(self::class);
    }
     ...
     * @return ReceptionTeam
     */
    public static function getReceptionTeamByName($name)
    {
        return self::getReceptionTeam('name = "'.$name.'"')->fetchObject(self::class);
    }
     ...
     * @param string $fields
     */
    public static function getReceptionTeam($where = null, $order = null, $limit = null, $group = null, $fields = '*'):PDOStatement
    {
        return (new Database('cnt_reception_team'))->select($where,$order,$limit,$group,$fields);
    }
}