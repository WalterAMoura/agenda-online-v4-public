...
class AuxWorshipTeamScheduler
{
    /**
     * Tabela usada pela classe
     * @var string
     */
    private $tabela = 'tb_aux_worship_team_scheduler';
    ...
    public function cadastrar()
    {
        ...
        $this->id = (new Database($this->tabela))->insert([
            ...
            'worship_music' => $this->worship_music,
            'singer_music' => $this->singer_music,
    ...
    {
        return (new Database('tb_aux_worship_team_scheduler'))->select($where,$order,$limit,$group,$fields);
    }
}