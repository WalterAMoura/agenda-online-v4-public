...
class AcceptedInviteWorship
{
    /**
     * Tabela usada pela classe
     * @var string
     */
    private string $tabela = 'tb_control_accepted_invite_worship';
    ...
    {
        return (new Database('cnt_control_accepted_invite_worship'))->select($where,$order,$limit,$group,$fields);
    }
}