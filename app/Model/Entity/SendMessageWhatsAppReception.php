...
class SendMessageWhatsAppReception
{
    /**
     * Tabela usada pela classe
     * @var string
     */
    private string $tabela = 'tb_send_message_whatsapp_reception';
     ...
     * @param int $id
     * @return SendMessageWhatsAppReception
     */
    ...
    {
        return (new Database('cnt_send_message_whatsapp_reception'))->select($where,$order,$limit,$group,$fields);
    }
}