...
class WorshipAskToChange
{
    /**
     * Tabela usada pela classe
     * @var string
     */
    private $tabela = 'tb_worship_ask_to_change';
    ...
    {
        return (new Database('cnt_ask_to_change_worship'))->select($where,$order,$limit,$group,$fields);
    }
}