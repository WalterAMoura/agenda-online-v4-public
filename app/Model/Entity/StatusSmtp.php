...
class StatusSmtp
{
     ...
     * @return StatusSmtp
     */
    public static function getStatusSmtpById($id)
    {
        return self::getStatusSmtp('id = '.$id)->fetchObject(self::class);
    }
     ...
     * @return StatusSmtp
     */
    public static function getStatusSmtpByName($statusEmail)
    {
        return self::getStatusSmtp('description = "'.$statusEmail.'"')->fetchObject(self::class);
    }
     ...
     * @param string $fields
     */
    public static function getStatusSmtp($where = null, $order = null, $limit = null, $group = null, $fields = '*'):PDOStatement
    {
