...
class StatusEmail
{
     ...
     * @var string
     */
    private $tabela = 'tb_status_email';
    /**
     * ‘ID’
     * @var integer
     */
     ...
     * @return StatusEmail
     */
    public static function getStatusEmailById($id)
    {
        return self::getStatusEmail('id = '.$id)->fetchObject(self::class);
    }
     ...
     * @return StatusEmail
     */
    public static function getStatusEmailByName($statusEmail)
    {
        return self::getStatusEmail('description = "'.$statusEmail.'"')->fetchObject(self::class);
    }
     ...
     * @param string $fields
     */
    public static function getStatusEmail($where = null, $order = null, $limit = null, $group = null, $fields = '*'):PDOStatement
    {
        return (new Database('tb_status_email'))->select($where,$order,$limit,$group,$fields);
    }
}