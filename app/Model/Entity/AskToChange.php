...
class AskToChange
{
     ...
     * @var string
     */
    private $tabela = 'tb_ask_to_change';
     ...
     * @var integer
     */
    public $scheduler_sound_device_id;

    /**
     * Nome do device
     * @var string
     */
    public $scheduler_sound_device_name;
    ...
    {
        return (new Database('cnt_ask_to_change'))->select($where,$order,$limit,$group,$fields);
    }
}