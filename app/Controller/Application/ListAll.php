...
class ListAll extends Page
{
    ...
    public static function getListAll(Request $request): string
    {
        ...
        //Conteúdo da home
        $content = View::render('application/modules/event/list-all/index',[
    ...
    private static function getEventsAllEvents(Request $request, int $year)
    {
        ...
        while ($obEvent = $results->fetchObject(EntityEvent::class)){
            $items .= View::render('application/modules/event/list-all/item',[
                'id' => $obEvent->id,
                'data' => $obEvent->start,
